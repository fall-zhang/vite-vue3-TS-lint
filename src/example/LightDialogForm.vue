<template>
  <el-dialog ref="drawer" v-model:visible="drawerShow" v-dialogDrag width="480px" :title="title" direction="rtl"
    @opened="onOpened">
    <div class="drawer-content">
      <el-form ref="lightForm" label-width="80px" label-position="right" :model="model" size="mini">
      ...
      <div class="drawer-footer">
        ...
        <el-button type="primary" size="small" @click="submitFrom">确认</el-button>
      </div>
    </div>
  </el-dialog>
</template>
