...
import { deBounce as debounce, deepClone as cloneDeep } from '@/utils/index'
import eventsOutside from './util/mixins'
...
export default {
  ...
  computed: {
    // active menus ids
    activeMenuIds(): any {
      const { panelOptions }: any = this

      return panelOptions.map((x: any) => x.parentId)
    },
  },
